...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFFF8000);
  late Color secondaryColor = const Color(0xFF2ABED8);
  late Color tertiaryColor = const Color(0xFFABE1FB);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xE2F6F6F6);
